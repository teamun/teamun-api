...
var ErrorCode = {
  ...
  ACTIVITY_GROUP_JOIN_UNKNOWN_ERROR: { code: 3010, desc: '报名失败：请重试' },
  ACTIVITY_GROUP_JOIN_NO_PLACES_ERROR: { code: 3011, desc: '报名失败：剩余名额不足，请稍后重试' },
  ACTIVITY_GROUP_ORDER_SAVE_ERROR: { code: 3020, desc: '订单保存失败，请稍后重试' },
  ACTIVITY_GROUP_ORDER_COMPLETE_PAYMENT_ERROR: { code: 3021, desc: '已成功报名，请刷新页面察看' },
